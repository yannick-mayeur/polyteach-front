      ...
      return (
         <>
            ...
            <Modal show={this.state.toggleModal} course={this.props.course} modalClosed={this.closeModal}>
               <CourseDetails editCourse={this.props.editCourse} user={this.props.user} removeCourse={this.props.removeCourse} rateCourse={this.props.rateCourse} toogleBookmarkCourse={this.props.toogleBookmarkCourse} course={this.props.course} modalClosed={this.closeModal} />
            </Modal>
         </>
      )
   }
